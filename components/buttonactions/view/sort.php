...
<div class="btn-group" role="group">
  ...
  <ul class="dropdown-menu" role="menu" <?php echo $class_dropdown_ul;?>>
	<li><a href="<?php echo '?'.$_SERVER['QUERY_STRING'] . '&orderby=ListPrice&order_direction=DESC#search-result-container';?>" class="price-high">Price (Highest)</a></li>
	<li><a href="<?php echo '?'.$_SERVER['QUERY_STRING'] . '&orderby=ListPrice&order_direction=ASC#search-result-container';?>" class="price-low">Price (Lowest)</a></li>

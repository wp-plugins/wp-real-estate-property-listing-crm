<?php
class Xout_Property extends Account_Dashboard{
	...
	public function get_property(){
		...
		if( count($fav) > 0 && $fav ){
			...
			foreach($fav as $key_db => $val_db){
				...
				$properties 	= apply_filters('hook_xout_property_' . $source, $data_property);
			...
			$col = 4;
			require_once GLOBAL_TEMPLATE . 'account/partials/xout-list.php';
		}else{
			return false;
		}
	}

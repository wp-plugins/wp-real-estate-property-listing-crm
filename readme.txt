...
* Push data that convert to leads, like email to friend, inquiry and register subscriber
* Display full details of a property
* Search Form with autocomplete for location
* Search result with infinite scroll as pagination
* Print PDF
...
We are planning in the next feature release to be able to choose pages on this URL's

It is highly customizable there is a default template of the properties or can be customized inside the theme
...
Signup for a CRM key first, heres how to, watch the video.
...
3. Put Masterdigm API key, token and broker id
4. Choose default feed ( CRM ), then hit Update button
5. Go to Masterdigm -> Settings
...
Masterdigm team of Project Manager and Developers decided to build this WP plugin because of the lack of a true CRM + WP Real Estate Plugin combo.  It’s one thing managing properties in the WP backend and its another in a CRM that allows property alerts, email marketing and more.
...
= Can the plugin work on a wp mulsite platform? =
...
1. Setup masterdigm api using api key, token and broker id, make sure to choose default feed to CRM.
2. List properties.
...
= 3.23.37 =
* added feature to change save search name

= 3.22.37 =
* add save search in the dashboard page
* display list of saved search and can be subscribe to property alert / delete and run the search

= 3.21.37 =
* update minor issue in subsriber dashboard on activation of plugin
...
= 3.18.33 =
* added page for registered user
* registered user dashboard to update profile and password
...
= 3.1.7 =
* update the breadcrumb to use MLS or both CRM and MLS api
...
= 2.8.3 =
* update plugin and add subvidisionid

= 2.8.2 =
* update inquire form, to auto add current user login in form fields
* update CRM and MLS class
* update signup form
...
= 2.5.0 =
* add lot area tidle hook

= 2.4.9 =
* update property list image to max width
* added filter on area, purpose to add tidle per theme function only

= 2.2.8 =
* create layout for list property if masonry is disable

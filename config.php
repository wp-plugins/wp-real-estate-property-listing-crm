...
//define('PLUGIN_PUBLIC_ASSET', WP_PLUGIN_DIR .'/'. PLUGIN_FOLDER_NAME . '/public/assets/');
...
define('MLS_VIEW', WP_PLUGIN_DIR .'/'. PLUGIN_FOLDER_NAME . '/public/mls/template/');
define('CRM_VIEW', WP_PLUGIN_DIR .'/'. PLUGIN_FOLDER_NAME . '/public/crm/template/');
...
//template
define('LIST_BOX_STYLE',GLOBAL_TEMPLATE,'list/default/list-default.php');
define('CAROUSEL_DEFAULT_SINGLE', PLUGIN_PUBLIC_DIR . 'partials/carousel/single-property-galleria.php');
//CRM
...
define('CRM_DEFAULT_SEARCH_RESULT', LAYOUT . 'searchresult/search-result.php');
define('CRM_DEFAULT_SEARCH_RESULT_SCROLL', GLOBAL_TEMPLATE . 'searchresult/scroll-search-result.php');
//MLS

	...
	<?php if( have_properties() ){ ?>
		<?php foreach(have_properties() as $property){ ?>
				<?php if( !is_null($property->properties->id) ) { ?>
						...
						<div class="col-xs-12 col-md-<?php echo bootstrap_grid_col(count($property_data));?> property-item property-id-<?php echo $property->properties->get_id();?> crm">
							...
							<div class="panel-footer">
								<?php
									$args_button_action = array(
										...
										'print' => array(
											'show' => 1,
											'url' => get_option('siteurl') . '/printpdf/'.$property->properties->get_id(),
										),
										'share'	=> array(
											'property->properties_id' => $property->properties->get_id(),
											'feed' => 'crm',

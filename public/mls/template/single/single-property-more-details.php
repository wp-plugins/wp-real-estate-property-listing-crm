<div class="row">
	<div class="col-md-6">
		<ul class="list-unstyled left-details">
			...
			<li>Lot Area: <?php echo get_single_property_data()->get_lot_area() . ' ' . get_single_property_data()->displayAreaMeasurement('lot')->area_type;?></li>
		</ul>
	</div>
	<div class="col-md-6">
		<ul class="list-unstyled right-details">
			...
			<li>Floor Area : <?php echo get_single_property_data()->get_floor_area(). ' ' . get_single_property_data()->displayAreaMeasurement('lot')->area_type;?></li>
...
<div class="row">
	<div class="col-md-12">
		<ul class="list-unstyled">
		  ...
		  <li class="">Fireplace YN : <?php echo get_single_property_data()->display_fireplace_yn() == 0 ? 'No':'Yes';?></li>
		  ...
		  <li class=""><a href="<?php echo get_single_property_data()->display_virtual_tour_link();?>" target="_blank">Click for Virtual Tour Link </a></li>
		  <li class="">Water Frontage : <?php echo get_single_property_data()->display_water_frontage();?></li>
		  <li class="">Water Frontage YN : <?php echo get_single_property_data()->display_water_frontage_yn() == 0 ? 'No':'Yes';?></li>

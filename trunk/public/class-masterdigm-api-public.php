...
class Masterdigm_API_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name . '-typeahead', plugin_dir_url( __FILE__ ) . 'js/typeahead.bundle.min.js', array( 'jquery' ), '0.10.5', true );
		...
		wp_enqueue_script( $this->plugin_name . '-lazyload', plugin_dir_url( __FILE__ ) . 'js/jquery.lazyload.min.js', array( 'jquery' ), '1.9.7', true );
		// localize
